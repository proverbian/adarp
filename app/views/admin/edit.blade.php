...
{{ Form::open(array('url'=>'admin/user/'.$profile->user_id.'/update'))}}
{{ Form::hidden('user_id',$profile->user_id) }}
{{ Form::hidden('updated_by',$admin_logged,array('class'=>'form-control')) }}
<div class="container">
<div class="row">
	<div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
			<span class="update-header">
		<a href="{{ URL::to('admin/user/'.$profile->user_id) }}" class="btn btn-success">Cancel</a>
	</span>
